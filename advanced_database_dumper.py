...
class DatabaseDumper:
    ...
    def __init__(self):
        # Read target from environment variable passed by framework
        self.target = os.environ.get('DSCYBER_TARGET', "http://testphp.vulnweb.com/")
        self.database = os.environ.get('DSCYBER_DATABASE', "acuart")
